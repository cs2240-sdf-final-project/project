...
std::vector<Segment> getSecondaryPath(const vec3 origin, const vec3 direction,RandomState *random,const SceneParams *params){
...
void render_pixel(
    ...
    std::vector<Segment> path = getSecondaryPath(origin , direction, random, params);
